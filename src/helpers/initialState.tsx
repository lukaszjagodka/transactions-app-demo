...
interface CurrenciesObjects {
  [key: string]: CurrencyObj;
}

export const initialCurrenciesObjects: CurrenciesObjects = {
  ALL: {
...
export const initialCurrenciesId: currnesId = [
  'PLN',
  'EUR',
  'ALL',
  'XCD',
...
export const initialCurrenciesRates = [{
